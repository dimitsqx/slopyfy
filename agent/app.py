...
agent = Agent(
    ...
    system_prompt=(
        ...
        "Wait for go_to_age_group to return ready=true before applying filters. "
        ...
        "Do not enumerate or describe product details unless the user explicitly asks for details "
        "(e.g., material, sizing, description). "
        "If the user expresses interest in a category or segment without asking for details, interpret "
        "it as intent to apply filters and keep the response concise. "
